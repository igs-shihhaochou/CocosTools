...
@ccclass('QuickTipContentGenerator')
export class QuickTipContentGenerator extends Component {
  @property(Node)
  ...
  @property({
    type: TTFFont,
    visible: function (this: QuickTipContentGenerator) {
  ...
  private generateContent() {
    ...
    Object.keys(this.translation).forEach((key, index) => {
      ...
      let count = -1;
      let str = this.enableNumberPrefix ? `${index + 1}.` : '';
      ...
      //get symbol image
      console.log('[QuickTipContentGenerator]', key, lines);
    });
  }
